...
import { SparklineChart, SparklineTheme } from './SparklineChart';
          ...
          <div className="p-4 overflow-y-auto custom-scrollbar flex-1 space-y-3">
            ...
            {activeTab === 'trends' && (
              <div className="space-y-3.5">
                ...
                {/* Secondary Mini Sparklines Multi-Stream Overview */}
                <div className="grid grid-cols-2 gap-2">
                  ...
                  <div className={`p-2.5 rounded-xl border ${cardBg}`}>
                    ...
                    />
                    <div className="mt-1 flex justify-between text-[9px] font-mono text-slate-400">
                      <span>Total: {metrics.totalCollisions}</span>
                      <span>Active: {metrics.activeContacts}</span>
                    </div>
                  </div>
                </div>

                {/* Simulation Trend Metrics Summary */}
                <div className={`p-2.5 rounded-xl border ${cardBg} space-y-1 text-xs`}>
                  <div className="text-[10px] font-semibold text-slate-400 uppercase tracking-wider mb-1">
                    Telemetry Trend Summary
                  </div>
                  ...
                  <div className="flex justify-between items-center text-[11px] font-mono">
                    ...
                    <span className="font-bold text-indigo-400">{metrics.peakForce.toFixed(2)} N</span>
                  </div>
                  <div className="flex justify-between items-center text-[11px] font-mono">
              ...
              <div className="space-y-3">
                ...
                <div className={`p-3 rounded-xl border ${cardBg} space-y-2`}>
                  ...
                  <div className="flex justify-between items-center text-[10px] text-slate-400">
                    <span>Controller: {(stats?.gripperCtrl ?? 0.04) > 0.02 ? 'Open (0.04m)' : 'Closed'}</span>
                    <span>Max: 20 N</span>
                  </div>
                </div>
                  ...
                  >
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-[9px] font-mono px-1 py-0.2 rounded bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 font-bold uppercase">
                          {tool.status}
                        </span>
                      </div>
                      {onOpenToolIntegration && (
